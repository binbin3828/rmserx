...
#define      ERR_SEND_FACE_NO_VIP           211008    //玩家发送猫星人表情时没有vip
#define      ERR_SEAT_DOWN_IP_SAME          211009    //坐下ip相同
#define      ERR_ENTER_ROOM_MAX_CHIP        211010    //筹码大于1W不能进入新手房间

/*****************************德州扑克命令***************************/

#define      CMD_READ_MEM_DATA    369999   //重新读内存数据
...
#define      CMD_RE_READ_USER_PACK      370065   //告诉服务器重新读用户信息
...
#define      CMD_LUCK_CARD_AWARD        370070   //幸运手牌奖励提示

#define      CMD_TASK_COM_TOOLTIP       370071   //任务完成提示
#define      CMD_CLEAN_ROOM_STATUS      370072   //一局完成清除桌面池子、公共牌、手牌、庄家位置

#define      CMD_GIVE_TIP_TO_DEALER     370073   //给荷官小费筹码
